...
public class TokenDetectorbis {
	...
	public Circle detectToken(Mat frame) {
		...
		Mat m = increaseContrast(blurred, 10.0, 5.);
                ...
                if (fixedRadius == null) {
                    ...
                    int minRadius = (int) (fixedRadius * 0.9); 
                    int maxRadius = (int) (fixedRadius * 1.1); 
                    Imgproc.HoughCircles(m, circles, Imgproc.HOUGH_GRADIENT, 1.3, 30, 150, 30, minRadius, maxRadius);
                }
	...
	public Mat displayHud(Mat frame, int scoreGameBlue, int scoreGameRed  ) {
